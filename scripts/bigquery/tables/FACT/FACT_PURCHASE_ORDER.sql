-- =============================================
-- OI Database Project - FACT_PURCHASE_ORDER Table
-- =============================================
-- Fact table for Purchase Orders
-- Populated from STG_PURCHASE_ORDER by SP_DATA_ENTRY_UPDATES
-- =============================================

CREATE TABLE IF NOT EXISTS `onyga-482313.OI.FACT_PURCHASE_ORDER` (
