...
('PRODUCT_DEFENSE', 1, 'SP', 'PRODUCT_TARGETING', 'DOWN_ONLY',
  0.30, 0.75, 10.0, 0, 300,
  'SP product targeting to defend your own detail pages',
  '{PRODUCT}-SP/PT (Defense)',
  TRUE, 'High Product Page boost. Prevents competitors from poaching your shoppers. Lean $10 budget — narrow per-ASIN targeting + low bid means low spend ceiling by design.'),

-- =============================================
-- RETARGETING: Re-engage past visitors
-- =============================================
('RETARGETING', 1, 'SB_VIDEO', 'BROAD', 'DOWN_ONLY',
  0.30, 1.00, 10.0, 100, 100,
