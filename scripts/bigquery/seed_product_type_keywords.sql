...
-- Item-level types; generic "accessories" stays the coarse fallback.
-- ═══════════════════════════════════════
('jewelry', 'Jewelry', 10),
('jewellery', 'Jewelry', 10),
('necklace', 'Necklace', 10),
('bracelet', 'Bracelet', 10),
('bracelets', 'Bracelet', 10),
('earrings', 'Earrings', 10),
('anklet', 'Jewelry', 10),
('pendant', 'Jewelry', 10),
('keychain', 'Keychain', 10),
('keyring', 'Keychain', 10),
('sunglasses', 'Sunglasses', 10),
('scrunchie', 'Hair Clip', 10),
('scrunchies', 'Hair Clip', 10),
('hair clip', 'Hair Clip', 10),
('hair clips', 'Hair Clip', 10),
('hair accessories', 'Hair Accessories', 10),
('headband', 'Headband', 10),
('headbands', 'Headband', 10),
('hair band', 'Headband', 10),
('hair bands', 'Headband', 10),
