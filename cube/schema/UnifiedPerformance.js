...
cube(`UnifiedPerformance`, {
  ...
  measures: {
    ...
    cogs: {
      ...
      type: `sum`,
      format: `currency`,
      description: `Total landed COGS (units × cost per unit). = cogsGoods + shippingCost + pickPackCost + referralCost.`,
    },
    cogsGoods: {
      sql: `cogs_goods`,
      type: `sum`,
      format: `currency`,
      description: `Goods-only COGS (units × cost_of_goods). Manufacturing cost, excludes freight/FBA/referral.`,
    },
    shippingCost: {
      sql: `shipping_cost`,
      type: `sum`,
      format: `currency`,
      description: `Inbound freight cost (units × shipping_cost per unit)`,
    },
    pickPackCost: {
      sql: `pick_pack_cost`,
      type: `sum`,
      format: `currency`,
      description: `FBA pick & pack fulfillment fees (units × estimated_pick_pack_fee_per_unit)`,
    },
    referralCost: {
      sql: `referral_cost`,
      type: `sum`,
      format: `currency`,
      description: `Amazon referral fees (units × estimated_referral_fee_per_unit)`,
    },
    orders: {
      sql: `orders`,
      type: `sum`,
  ...
  preAggregations: {
    ...
    weeklyByFamily: {
      ...
      measures: [
        ...
        UnifiedPerformance.cogsGoods,
        UnifiedPerformance.shippingCost,
        UnifiedPerformance.pickPackCost,
        UnifiedPerformance.referralCost,
