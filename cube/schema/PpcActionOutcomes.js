...
cube(`PpcActionOutcomes`, {
  ...
  dimensions: {
    ...
    postDaysElapsed: { sql: `post_days_elapsed`, type: `number`, description: `Complete post-window days available (max 7)` },
    preSpend: { sql: `pre_spend`, type: `number` },
    preOrders: { sql: `pre_orders`, type: `number` },
    preUnits: { sql: `pre_units`, type: `number` },
    preClicks: { sql: `pre_clicks`, type: `number` },
    ...
    preUnitsPerDay: { sql: `pre_units_per_day`, type: `number`, description: `Pre-window units sold per day (7d avg)` },
    preNetProfitPerDay: { sql: `pre_net_profit_per_day`, type: `number`, description: `Pre-window net profit per day (7d avg)` },
    preCpc: { sql: `pre_cpc`, type: `number`, description: `Pre-window CPC = spend / clicks` },
    postSpend: { sql: `post_spend`, type: `number` },
    postOrders: { sql: `post_orders`, type: `number` },
    postUnits: { sql: `post_units`, type: `number` },
    postClicks: { sql: `post_clicks`, type: `number` },
    ...
    postUnitsPerDay: { sql: `post_units_per_day`, type: `number`, description: `Post-window units sold per day (avg over days elapsed)` },
    postNetProfitPerDay: { sql: `post_net_profit_per_day`, type: `number`, description: `Post-window net profit per day (avg over days elapsed)` },
    postCpc: { sql: `post_cpc`, type: `number`, description: `Post-window CPC = spend / clicks` },
