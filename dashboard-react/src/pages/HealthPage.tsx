...
const DATA_CHECKS: {
  ...
  { label: 'Coach terms',                   dataKey: 'coach_terms',           cubeSource: 'AdsCoachTerms',      minRows: 0, critical: false, loaderName: 'coachTerms' },
  ...
  { label: 'Actions (recommendations)',     dataKey: 'actions',               cubeSource: 'AdsCoachDecision',   minRows: 1, critical: true,  loaderName: 'actions' },
